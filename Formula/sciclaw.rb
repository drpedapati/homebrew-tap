class Sciclaw < Formula
  ...
  resource "source" do
    url "https://github.com/drpedapati/sciclaw/releases/download/v0.2.1/source-sciclaw-v0.2.1-source.tar.gz"
    sha256 "bef95cca262e08d46e4803dcb0f51f491584b22aea031a570f2f1a4bcadb404b"
  end
